...
export class XHRStreamer {
    ...
    get_fileData(scope, url, onLoad, onProgress, onError, onAbort, onLoadChunk){
        ...
        /*request.addEventListener("progress", onProgress);*/// readyState will be 3
        //request.addEventListener("load", onLoad);// readyState will be 4
        //request.addEventListener("error", onError);// readyState will be 4
        //request.addEventListener("abort", onAbort);// readyState will be 4

...
export class RenderTarget {
	...
	addDepthTexture() {
		this._depthTexture = new Texture(undefined, Texture.ClampToEdgeWrapping, Texture.ClampToEdgeWrapping,
			Texture.NearestFilter, Texture.NearestFilter, Texture.DEPTH_COMPONENT24, Texture.DEPTH_COMPONENT, Texture.UNSIGNED_INT, this._width, this._height);
	}

...
class App {
	constructor(canvas) {
		...
		this.loadResourcesAndAnimate(); // TODO: Cleanup
	}


	initScene() {
		// Main scene
		this.camera = new RC.PerspectiveCamera(60, 16 / 9, 0.1, 1000);
	...
	update() {
		...
		this.timer.curr = performance.now(); // Convert to seconds
